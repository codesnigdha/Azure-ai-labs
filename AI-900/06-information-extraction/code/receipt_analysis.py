"""
Analyze a receipt using Azure Content Understanding.
...
Configuration:
    ...
    - YOUR_FILE_URL:
        URL of the receipt or document to analyze.
...
def main() -> None:
    ...
    # URL of the receipt/document to analyze
    file_url = "YOUR_FILE_URL"

    # Analyzer used for extracting receipt-specific information
